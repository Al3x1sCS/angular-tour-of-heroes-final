...
export const HEROES: Hero[] = [
  ...
  },
  {
      id: 2,
      name: 'Desloca-Pouco',
      origem: 'João, sempre foi um viajante curioso e aventureiro. Desde jovem, ele sonhava em explorar o mundo e descobrir lugares mágicos e misteriosos. Em uma de suas viagens, enquanto caminhava por uma floresta densa e antiga, João encontrou uma fonte mágica escondida entre as árvores. A fonte brilhava com uma luz suave e encantadora, e João, fascinado, decidiu fazer um desejo. Ele desejou ter o poder de se teletransportar para poder explorar o mundo de forma mais rápida e eficiente. No entanto, a fonte, com seu senso de humor peculiar, concedeu-lhe o poder de se teletransportar apenas 1 cm de cada vez.',
